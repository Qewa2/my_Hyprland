...
int main(){
    ...
    const double CONST_PI = 3.14159; //const variables are ususally wirtten in uppercase letters
    //const_pi = 420.65; this thows an error since const_pi cant be changed
    double radius = 10;
    double circumference = 2*CONST_PI*radius;
